...
public class ElbowGoToPosition extends Command {
    private final ElbowSystem elbow;
    private final double position;

    /** Creates a new ElbowGoToPosition. */
    public ElbowGoToPosition(final ElbowSystem elbow, final PositionDetails positionDetails, Position pos) {
        // Use addRequirements() here to declare subsystem dependencies.
        this.elbow = elbow;
        addRequirements(elbow);
        position = positionDetails.getElbowPos(pos);
    }
    ...
    @Override
    public void execute() {
        System.out.println("elbow: " + elbow.getNewSpeed(position));
