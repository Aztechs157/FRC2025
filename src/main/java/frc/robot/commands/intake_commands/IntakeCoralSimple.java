...
public class IntakeCoralSimple extends Command {
  private final IntakeSystem intakeSystem;
  private int holdCounter = 0;

  /** Creates a new IntakeCoral. */
  public IntakeCoralSimple(final IntakeSystem intakeSystem) {
  ...
  public boolean isFinished() {
    ...
    return holdCounter >= IntakeConstants.CORAL_HOLD_COUNTER;
  }
}
