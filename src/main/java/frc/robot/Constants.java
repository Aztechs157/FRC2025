...
public class Constants {
    ...
    public static class ElevatorConstants {
        ...
        // IDs/Ports for the sensors/actuators. The motor uses a CAN ID, the POT (short for potentiometer) uses an analog input port, and the limits use digital I/O ports
        ...
        /** The margin, as a percentage (ie 1.0 = 100%) of the travel that is off limits on both the top and the bottom of the travel. */
    ...
    public static class IntakeConstants {
        ...
        // IDs/Ports for the sensors/actuators. The motor uses a CAN ID, the sensor uses a digital I/O
        public static final int MOTOR_ID = 22;
        public static final int SENSOR_ID = 1;

        /** The speed, as a percentage of total power, to run the intake motor at for the specified action. */
    ...
    public static class ElbowConstants {
        // IDs/Ports for the sensors/actuators. The motor uses a CAN ID, the encoder uses a digital I/O
    ...
    public static class WristConstants {
        ...
        /** Position limits, in raw encoder units. In this case, rotations. This defines our virtual limits. The minimum position is when the elbow is at the top. */
    ...
    public static class UppiesConstants {
        ...
        /** Position limits, in raw encoder units, for the left Uppies motor. In this case, the raw encoder unit is rotations. This defines our virtual limits. */
        public static final double LEFT_MAX_POSITION = 0.3228, LEFT_MIN_POSITION = 0.7053;

        /** Position limits, in raw encoder units, for the right Uppies motor. In this case, the raw encoder unit is rotations. This defines our virtual limits. */
