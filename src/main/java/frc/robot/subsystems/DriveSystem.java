...
import frc.robot.generated.AlphaTunerConstants.TunerSwerveDrivetrain;
...
public class DriveSystem extends TunerSwerveDrivetrain implements Subsystem {
    ...
    public boolean atTargetPose(Pose2d targetPose) {
        ...
        return positionError < 0.01 && angleError < 1.0; // Example thresholds (0.1 meters and 5 degrees)
    }
