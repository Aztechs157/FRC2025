 ...
 * 
 * This largely functions like a {@link java.util.TreeMap TreeMap} but with a
 * custom comparator that uses priorities given by the user to order the
 * entries. However, it also lets you use just the key to access the value
 * without needing to know the priority given to that key-value mapping.
 * 
 * Priorities are integers, where a lower number corresponds to an earlier
 * value, and higher numbers to a later values. When there is a tie the key
...
public final class PriorityMap<K extends Comparable<K>, V> {
    ...
    /**
     * Associates the specified value with the specified key at the specified
     * priority.
     * 
     * Lower priorities come earlier than later priorities, when there is a tie the
     * comparison falls back to the key.
     * 
     ...
     *         there was no
     *         mapping for the key. (A <code>null</code> return can also indicate
     *         that the map
     *         previously associated <code>null</code> with key.)
     */
    ...
    /**
     * Removes the mapping for this key from this <code>PriorityMap</code> if
     * present.
     * 
     * @param key key for which mapping should be removed
     * @return the previous value associated with key, or <code>null</code> if there
     *         was no
     *         mapping for key. (A <code>null</code> return can also indicate that
     *         the map
     *         previously associated <code>null</code> with key.)
     */
    ...
    /**
     * Returns the first value according to the priorities given for each key-value
     * mapping, or <code>null</code> if the map is empty.
     * 
     * If there is a tie for the lowest priority, the key will be used as a
     * tie-breaker.
     * 
     * @return the value with the lowest priority, or <code>null</code> if the map
     *         is empty
     */
    public V firstValue() {
        if (isEmpty()) {
        ...
        return valueMap.firstEntry()
                .getValue();
    }

    /**
     * Returns the last value according to the priorities given for each key-value
     * mapping, or <code>null</code> if the map is empty.
     * 
     * If there is a tie for the highest priority, the key will be used as a
     * tie-breaker.
     * 
     * @return the value with the highest priority, or <code>null</code> if the map
     *         is empty
     */
    public V lastValue() {
        if (isEmpty()) {
        ...
        return valueMap.lastEntry()
                .getValue();
    }

    /**
     * Returns the first key according to the priorities given for each key-value
     * mapping, or <code>null</code> if the map is empty.
     * 
     * If there is a tie for the lowest priority, the key will be used as a
     * tie-breaker.
     * 
     * @return the key with the lowest priority, or <code>null</code> if the map is
     *         empty
     */
    public K firstKey() {
        if (isEmpty()) {
    ...
    /**
     * Returns the last key according to the priorities given for each key-value
     * mapping, or <code>null</code> if the map is empty.
     * 
     * If there is a tie for the highest priority, the key will be used as a
     * tie-breaker.
     * 
     * @return the key with the highest priority, or <code>null</code> if the map is
     *         empty
     */
    public K lastKey() {
        if (isEmpty()) {
     ...
     * 
     * A return value of <code>null</code> does not necessarily indicate that the
     * map contains no
     * mapping for the key; it's also possible that the map explicitly maps the key
     * to <code>null</code>. The containsKey operation may be used to distinguish
     * these two
     * cases.
     * 
     ...
     * @return the priority to which the specified key is mapped at, or
     *         <code>null</code>
     *         if this map contains no mapping for the key
     */
    ...
    /**
     * Returns a shallow copy of this <code>PriorityMap</code> instance: the keys
     ...
     * some value, with the same priority as the previous mapping.
     * 
     * @param key   key with which the specified value is associated
     * @param value value to be associated with the specified key
     * @return the previous value associated with the specified key, or
     *         <code>null</code> if
     *         there was no mapping for the key. (A <code>null</code> return can
     *         also indicate
    ...
    /**
     * Replaces the entry for the specified key at the specified priority only if it
